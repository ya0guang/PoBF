    ...
    D: EncDec<K>,
{
    ...
    fn decrypt_data(self) -> SgxResult<ComputingTask<DataDecrypted, K, D>> {
...
where
    ...
    D: EncDec<K>,
{
    fn do_compute(self, task: &dyn Fn(&D) -> D) -> SgxResult<ComputingTask<ResultDecrypted, K, D>> {
        Ok(ComputingTask {
            key: self.key,
            data: Data {
...
where
    ...
    D: EncDec<K>,
{
    fn encrypt_result(self) -> SgxResult<ComputingTask<ResultEncrypted, K, D>> {
