// https://github.com/hanabi1224/Programming-Language-Benchmarks/blob/main/bench/algorithm/fannkuch-redux/1.rs
...
pub fn private_computation(input: Vec<u8>) -> Vec<u8> {
    ...
    let mut ans = Vec::new();
    ans.extend_from_slice(&checksum.to_le_bytes());
    ans.extend_from_slice(&maxflips.to_le_bytes());
