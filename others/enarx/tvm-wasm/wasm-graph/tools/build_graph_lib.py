...
"""Builds a simple resnet152 graph for testing."""
import argparse
import os
import subprocess
import sys
...
# This example uses resnet152-v2-7 model
model_url = (
...
def build_graph_lib(opt_level):
    ...
    model_path = download_testdata(model_url, "resnet152-v2-7.onnx", module="onnx")
    ...
    target = "llvm -mtriple=wasm32-wasi"
